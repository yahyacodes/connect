    ...
    <footer className="p-4 footer-bg sm:p-6">
      <div className="text-center mt-32">
        <div className="mb-20">
          ...
          <button
            type="button"
            className="text-black uppercase mt-4 bg-secondary-color font-medium rounded text-xs px-5 py-2.5 text-center mr-3 md:mr-0"
          >
            Join For Free
          </button>
          <button
            type="button"
            className="text-white mx-3 uppercase mt-4 bg-header-color border-secondary-color border-2 font-medium rounded text-xs px-5 py-2.5 text-center mr-3 md:mr-0"
          >
            Talk to Sales
          </button>
        </div>
        <div className="md:flex md:justify-center">
          ...
          <div className="grid grid-cols-2 gap-0 sm:gap-0 sm:grid-cols-5">
            ...
            <div>
              ...
              <ul className="text-gray-400">
                <li className="mb-4">Sellers</li>
                <li className="mb-4">Buyers</li>
                <li className="mb-4">Patners</li>
            ...
            <div>
              ...
              <ul className="text-gray-400">
                <li className="mb-4">Plans</li>
                <li className="mb-4">Personal</li>
                <li className="mb-4">Pro</li>
                <li className="mb-4">Enterprise</li>
              </ul>
            </div>
            <div>
